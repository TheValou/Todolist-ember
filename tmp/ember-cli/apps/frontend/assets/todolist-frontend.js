...
;define('todolist-frontend/initializers/ember-cli-rails-addon-csrf', ['exports'], function (exports) {
  'use strict';
...
;define('todolist-frontend/config/environment', [], function() {
          ...
          var exports = {
            'default': {"modulePrefix":"todolist-frontend","environment":"development","rootURL":"/","locationType":"auto","EmberENV":{"FEATURES":{},"EXTEND_PROTOTYPES":{"Date":false}},"APP":{"name":"todolist-frontend","version":"0.0.0+d765ffbc"},"emberData":{"enableRecordDataRFCBuild":false},"exportApplicationGlobal":true}
          };
